...
if (isset($_POST['isbn'])) {
  ...
  $query = "UPDATE books SET book_title='$title', book_author='$author', book_genre='$genre' WHERE books.ISBN = $isbn";
        ...
        <section id="cta">
            ...
            <form method="post">
                  <div class="align-center">
                    <p> Please fill in the fields with the previous values if you would not like to change them. </p>
                    ...
                    <input class="align-center" type="submit" id="create_button" value="Update" />
                  </div>
            </form>
