...
if (isset($_POST['isbn'])) {
  ...
  $query = "INSERT INTO bookcopies (book_status, isbn, user_id) VALUES ('in', $isbn, NULL)";
        ...
        <section id="cta">
            ...
            <form method="post">
                  <div class="align-center">
                    <p> Enter the ISBN of the book you would like to create a copy of. </p>
                    <input class="align-center" type="text" id="isbn" name="isbn" placeholder="ISBN" required/>
                  </br>
                    <input class="align-center" type="submit" id="create_button" value="Create Copy" />
                  </div>
            </form>
